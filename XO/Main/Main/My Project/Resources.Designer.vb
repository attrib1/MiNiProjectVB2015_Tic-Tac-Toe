...
Namespace My.Resources
    ...
    Friend Module Resources
        ...
        '''</summary>
        Friend ReadOnly Property blue_die() As Byte()
            Get
                Dim obj As Object = ResourceManager.GetObject("blue_die", resourceCulture)
        ...
        '''  Looks up a localized resource of type System.Byte[].
        '''</summary>
        Friend ReadOnly Property blue_f() As Byte()
            Get
                Dim obj As Object = ResourceManager.GetObject("blue_f", resourceCulture)
                Return CType(obj,Byte())
            End Get
        End Property
        ...
        '''  Looks up a localized resource of type System.Byte[].
        '''</summary>
        Friend ReadOnly Property intro_d() As Byte()
            Get
                Dim obj As Object = ResourceManager.GetObject("intro_d", resourceCulture)
                Return CType(obj,Byte())
            End Get
        End Property
        ...
        Friend ReadOnly Property red_die() As Byte()
            Get
                Dim obj As Object = ResourceManager.GetObject("red_die", resourceCulture)
                Return CType(obj,Byte())
            End Get
        End Property
        ...
        '''  Looks up a localized resource of type System.Byte[].
        '''</summary>
        Friend ReadOnly Property red_f() As Byte()
            Get
